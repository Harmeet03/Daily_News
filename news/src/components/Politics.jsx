        ...
        return(
             <>  
                <div className="min-h-screen dark:bg-gray-700 dark:text-white">
                    <Navbar/>
                    <h2 className="text-3xl text-center sm:text-4xl sm:px-16 text-blue-500 mt-8"> POLITICS NEWS </h2>
                    <Loader/>
                </div>
            </>
        );
    ...
    return(
        <>
            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-700 dark:text-white transition-all">
                <Navbar/>
                <h2 className="text-3xl text-center sm:text-4xl text-blue-500 mt-8"> POLITICS NEWS </h2>
